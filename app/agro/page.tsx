    ...
    <>
      ...
      <main>
        ...
        <section className="relative bg-primary py-20 lg:py-28">
          <div className="absolute inset-0 bg-[url('/images/banners/agro.jpg')] bg-cover bg-center" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <p className="mt-4 max-w-2xl text-lg text-primary-foreground/70">
              Soluciones tecnológicas para la industria agropecuaria.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <p className="mx-auto max-w-3xl text-center text-lg text-muted-foreground">
              Proporcionamos maquinaria y equipos innovadores diseñados para maximizar el rendimiento, la eficiencia y la sostenibilidad en el sector agroindustrial.
            </p>
          </div>
        </section>
