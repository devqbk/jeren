...
export default function PetroleoGasPage() {
  const brands = marcasNuevas.filter((brand) => brand.industrias.includes("petroleo-gas"))
    ...
    <>
      ...
      <main>
        ...
        <section className="relative bg-primary py-20 lg:py-28">
          <div className="absolute inset-0 bg-[url('/images/banners/petroleo-gas.jpg')] bg-cover bg-center" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <p className="mt-4 max-w-2xl text-lg text-primary-foreground/70">
              Equipamiento y soluciones para la industria petrolera y gasífera.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <p className="mx-auto max-w-3xl text-center text-lg text-muted-foreground">
              Proporcionamos tecnología especializada para optimizar operaciones, mejorar la seguridad y reducir el impacto ambiental en el sector de petróleo y gas.
            </p>
          </div>
        </section>
