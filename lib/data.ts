...
export const servicios = [
  {
    title: "Soporte 24x7",
    description: "Asistencia técnica las 24 horas, los 7 días de la semana en Buenos Aires, Río Grande y Ushuaia.",
    icon: "clock",
  },
  {
    title: "Stock de Insumos",
    description: "Contamos con stock de insumos y partes de reposición para respuesta inmediata.",
    icon: "package",
  },
  {
    title: "Respaldo OEM",
    description: "Trabajamos con apoyo directo de las OEM para soporte técnico especializado.",
    icon: "shield",
  },
  {
    title: "Cobertura Nacional",
    description: "Oficinas en Ciudad de Buenos Aires y sucursales en Tierra del Fuego.",
    icon: "map",
  },
]
