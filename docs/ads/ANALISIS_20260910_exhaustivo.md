...
**Fase 2 (Ads) pendiente**, script listo: anuncios nuevos en los 6 grupos con titulares literales fijados e inserción de ubicación, URL final por rotor en Cigüeñales/Ventiladores/Turbos, 9 keywords pausadas, 31 nuevas (incluye `balanceadoras de cardanes` en plural por el dato de Fabián del 10/09 y `balanceadoras tob`), Marca movida a dos grupos en Comercial con puja 800, fragmento "Tipos". Bloqueada por el clasificador de permisos de auto mode. La fase 5 y las preguntas de la sección 6 son de Ariel.
